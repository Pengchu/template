define(['js/virtual-template'],function (e) {
	"use strict";

	function i() {
		l.target = "";
		var e = window.Data;
		l.curId = e.id || "mp1445241432", l.list = e.list && e.list.list && e.list.list.length > 0 ? e.list.list : [];
	}
	...
	function t() {
		$("#iframe").on("load", s), $("#resMenu").on("click", 'dt[data-leaf="1"]', function () {
			...
			if (l.curId != i) {
				...
				var n = ["/develop doc/frame/", l.curId, '.html'];
				var t = "/develop doc/frame/" + i + '.html';
				window.history && history.replaceState ? (r(n.join("")),history.replaceState(history.state, document.title, t)) : location.href = t;
			}
	...
	i(), n(), t(), c(), window.__resFunc = {
		goback: function () {
			l.curId && r("frame/" + l.curId + "&t=" + Math.random());
		},
		scrollTop: function () {
